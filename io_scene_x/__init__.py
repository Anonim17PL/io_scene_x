...
bl_info = {
    "name": "DirectX X Format (Updated to Blender 2.83)",
    "author": "Chris Foster, Anonim17PL (A17PL)",
    "version": (4, 0, 1),
    "blender": (2, 83, 0),
    "location": "File > Export > DirectX (.x)",
    "description": "Export only: mesh vertices, UV's, materials (only Principled BSDF) and textures. "
